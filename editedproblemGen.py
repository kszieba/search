...
if __name__=="__main__":
    ...
    argParser.add_argument('-f', type = str, help = "Name of output file/name of new puzzle")
    ...
    if block_number!=None:
        blocks = int(block_number)
    if outputfile != None:
        problem = outputfile
    main(blocks, problem, stack_number, goal_stack_number)